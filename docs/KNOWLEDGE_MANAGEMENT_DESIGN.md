...
- Neo4j authentication is enabled by default; provide a strong `KM_NEO4J_PASSWORD` (auto-generated by `bin/km-bootstrap`) and only set `KM_NEO4J_AUTH_ENABLED=false` for isolated development environments.
